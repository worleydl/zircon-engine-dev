...
// cl_bobmodel_speed 4; cl_bobmodel_side 0; cl_bobmodel 0.06
cvar_t cl_bobmodel = {CVAR_SAVE, "cl_bobmodel", "0.06", "enables gun bobbing"};
cvar_t cl_bobmodel_side = {CVAR_SAVE, "cl_bobmodel_side", "0", "gun bobbing sideways sway amount"};
cvar_t cl_bobmodel_speed = {CVAR_SAVE, "cl_bobmodel_speed", "4", "gun bobbing speed"};
...
void V_CalcViewBlend(void)
{
	...
	if (cls.state == ca_connected && cls.signon == SIGNONS)
	{
		...
		if (supercontents & SUPERCONTENTS_LIQUIDSMASK)
		{
			...
			cl.cshifts[CSHIFT_CONTENTS].percent = 0.75; //150 * 0.5;
		}
		else
		{
			cl.cshifts[CSHIFT_CONTENTS].destcolor[0] = 0;
