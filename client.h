...
typedef enum r_stat_e
{
	...
	r_stat_batch_dynamic_batches_because_deformvertexes_roundwave, // Au 15
	r_stat_batch_dynamic_surfaces_because_deformvertexes_roundwave,
	r_stat_batch_dynamic_vertices_because_deformvertexes_roundwave,
	r_stat_batch_dynamic_triangles_because_deformvertexes_roundwave,
...
//[515]: added for csqc purposes
	...
	qbool csqc_paused; // vortex: int because could be flags
...
typedef struct r_refdef_s
{
	...
	float frustumscale_x, frustumscale_y, waterwarp2;
