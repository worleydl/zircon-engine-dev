...
void LoadPortals( char *name ){
	...
	if ( numBSPVisBytes > MAX_MAP_VISIBILITY ) {
		Error( "MAX_MAP_VISIBILITY exceeded (numBSPVisBytes %u / %u  = %f)", numBSPVisBytes, MAX_MAP_VISIBILITY, (float)numBSPVisBytes/MAX_MAP_VISIBILITY );
	} else {
		Sys_Printf( "Visibility OK (numBSPVisBytes %u / %u  = %f)\n", numBSPVisBytes, MAX_MAP_VISIBILITY, (float)numBSPVisBytes/MAX_MAP_VISIBILITY );
	}
