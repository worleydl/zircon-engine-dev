...
#define DPVSIMPLEDECODEERROR_NONE_0 0
#define DPVSIMPLEDECODEERROR_EOF_1 1
#define DPVSIMPLEDECODEERROR_READERROR_2 2
#define DPVSIMPLEDECODEERROR_SOUNDBUFFERTOOSMALL_3 3
#define DPVSIMPLEDECODEERROR_INVALIDRMASK_4 4
#define DPVSIMPLEDECODEERROR_INVALIDGMASK_5 5
#define DPVSIMPLEDECODEERROR_INVALIDBMASK_6 6
